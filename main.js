                ...
                <div class="px-4 sm:px-10 lg:px-20">
                    <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
                        ...
                        <div id="block"
                            ...
                            <h1 class="dark:text-gray-100 m-3 text-2xl sm:text-4xl font-bold tracking-tight mb-4">Tools</h1>
                            <div class="flex flex-wrap gap-3 px-2 sm:px-5 pt-3 sm:pt-6">
                                ...
                                <img class="w-8 h-8 sm:w-16 sm:h-16 mb-5" src="https://skillicons.dev/icons?i=jenkins"
                                    alt="Jenkins">
                                <img class="w-8 h-8 sm:w-16 sm:h-16 mb-5" src="https://skillicons.dev/icons?i=githubactions"
                                    alt="Github-Actions">
                        ...
                        <div id="block"
                            ...
                            <h1 class="dark:text-gray-100 m-3 text-2xl sm:text-4xl font-bold tracking-tight mb-4">Frontend
                            </h1>
                            <div class="flex flex-wrap gap-3 px-2 sm:px-5 pt-3 sm:pt-6">
                            ...
                            <h1 class="dark:text-gray-100 m-3 text-2xl sm:text-4xl font-bold tracking-tight mb-4">Backend
                            </h1>
                            <div class="flex flex-wrap gap-3 px-2 sm:px-5 pt-3 sm:pt-6">
